...
const renderColumn = (columnData) => 
  ...
  return (
    ...
    />
      ...
      {/* Footer content */}
      {/* <div className="grid grid-cols-1 justify-center max-w-[1240px] gap-6  mx-auto py-16 px-4 gap-x-1 md:grid-cols-4 sm:grid-cols-5 lg:grid-cols-5"> */}
            <div className="grid grid-cols-1  sm:grid-cols-2  max-w-[1240px] mx-auto gap-6  py-16 px-4 md:grid-cols-3  lg:grid-cols-6  ">
        ...
        <div className="sm:col-span-1 md:col-span-2 lg:col-span-4  grid grid-cols-1 sm:grid-cols-2 md: ">
        
          <ul className="space-y-2 mt-2 min-w-[200px]" role="list"></ul>
