...
//   };
  ...
  return (
    ...
    <section className="bg-gradient-to-br from-[#E5F5FD] via-[#E5F5FD] to-white  py-8 px-4 sm:px-8 rounded-lg ">
...
>
          ...
          <button
            ...
            className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 z-20 text-white hover:bg-[#2F6281] cursor-pointer p-3 bg-black bg-opacity-50 rounded-full"
          >
            <MdKeyboardArrowLeft size={28}/>
          </button>
          <button
            onClick={handleRightClick}
            className="absolute right-2 sm:right-4 top-1/2 transform -translate-y-1/2 z-20 text-white hover:bg-[#2F6281] cursor-pointer p-3 bg-black bg-opacity-50 rounded-full"
          >
