...
const notifications = [
  ...
  },
  {
    id: 1,
    title:
      "List of selected candidates for AcSIR Ph.D. August 2025 session  List of selected candidates for AcSIR Ph.D. August 2025 session",
    pageURL: "https://www.ngri.res.in/cms/AcSIR.php",
  },
  {
    id: 2,
    title:
      "Schedule of Proficiency in Computer Typing Test - Junior Secretariat Assistant Advertisement No. 02/2025 Dated  Schedule of Proficiency in Computer Typing Test - Junior Secretariat Assistant Advertisement No. 02/2025 Dated 01.04.2025",
        ...
        <div className="border border-blue-500 bg-white  rounded-lg shadow-lg  mx-auto overflow-hidden">
          <div className="flex flex-col sm:flex-row sm:items-center px-3 sm:px-4 lg:px-6 py-3 sm:py-4 justify-between bg-blue-500">
            ...
            <a
              ...
              className=" font-sans text-sm sm:text-lg lg:text-xl  text-white hover:text-blue-200 rounded-lg transition-colors duration-300 self-start sm:self-auto "
            >
              View All
            </a>
          </div>
          ...
          >
            <div className="py-3 sm:py-4 lg:py-6 px-3 sm:px-4 lg:px-6 ">
              {[...notifications, ...notifications].map(
                (notification, index) => (
                  <div
                    className="mb-4 sm:mb-5 lg:mb-6 p-2 sm:p-3  lg:p-4"
