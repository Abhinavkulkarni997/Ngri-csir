...
<section className='bg-[#E5F5FD]  py-4 sm:py-6 lg:py-8  px-2 sm:px-4 lg:px-6'>
   {/* <h1 className='text-center text-lg sm:text-xl lg:text-2xl text-[#455cc5] font-bold font-sans mb-4 sm:mb-6'>NGRI GALLERY</h1> */}
      ...
      {/* <h1 className="text-center text-xl sm:text-2xl md:text-3xl text-[#2F6281] font-bold  mb-4 sm:mb-6 md:mb-8 font-serif">
  NGRI GALLERY
</h1> */}
  <h1 className="text-center text-xl sm:text-2xl md:text-3xl text-[#2F6281] font-bold  mb-2 sm:mb-3 md:mb-4 font-serif">
  NGRI GALLERY
</h1>
<div className="mt-2 w-28 h-1 mx-auto rounded-full bg-[#2F6281]"></div>
</div>
